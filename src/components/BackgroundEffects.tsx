        ...
        <div className="fixed inset-0" style={{ zIndex: -17 }}>
          {[...Array(120)].map((_, i) => (
            <motion.div
              ...
              style={{
                width: `clamp(1px, ${Math.random() * 0.3 + 0.15}vw, 4px)`, // Slightly smaller, more numerous
                height: `clamp(1px, ${Math.random() * 0.3 + 0.15}vw, 4px)`,
                background: `hsl(${220 + Math.random() * 40}, 100%, ${90 + Math.random() * 10}%)`, // Brighter, bluer stars
              ...
              transition={{
                duration: Math.random() * 3 + 2, // Smoother twinkle
                repeat: Infinity,
                delay: Math.random() * 4,
                ease: 'easeInOut',
              }}
          ...
          {[...Array(4)].map((_, i) => (
            <motion.div
              ...
              transition={{
                duration: 2, // Faster shooting stars
                repeat: Infinity,
